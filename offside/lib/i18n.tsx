...
const dictionaries: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "landing.tagline": "World Cup 2026 · Prediction League",
    ...
    "history.title": "Season history", "history.subtitle": "Your points from completed competitions", "history.empty": "No completed seasons yet.", "history.points": "points",
  },
  ar: {
    ...
    "landing.tagline": "كأس العالم 2026 · دوري التوقعات",
  ...
  ckb: {
    ...
    "landing.tagline": "جامی جیهانی ٢٠٢٦ · یاری پێشبینیکردن",
    "landing.feature1": "پێشبینی ئەنجام", "landing.feature2": "یەک بووست بۆ هەر خولێک", "landing.feature3": "ئەنجامی سەلامەت",
    "landing.join": "بەشداربە لە یاریەکەدا", "landing.haveAccount": "هەژمارت هەیە؟ بچۆ ژوورەوە",
    "landing.next": "داهاتوو",
    "auth.username": "ناوی بەکارهێنەر", "auth.password": "وشەی نهێنی", "auth.email": "ئیمەیڵ (ئارەزوومەندانە)",
    ...
    "match.useBoost": "بووست بەکاربێنە (خاڵ ×2)", "match.boostActive": "بووست چالاکە (خاڵ ×2)",
    "match.boostUsedElsewhere": "بووست لە یارییەکی تر بەکارهاتووە",
    "match.save": "پاشەکەوتی پێشبینی", "match.saving": "پاشەکەوتکردن...", "match.edit": "گۆڕانکاری",
    "match.enterBoth": "هەردوو ئەنجام بنووسە", "match.saved.toast": "پێشبینی پاشەکەوتکرا",
    "match.baghdad": "بەغداد",
    "leaderboard.title": "پلەبەندی", "leaderboard.noPlayers": "هێشتا هیچ یاریزانێک نییە.",
    "leaderboard.scored": "خاڵدراوە",
    "stats.title": "ئامارەکانم", "stats.totalPoints": "کۆی خاڵەکان", "stats.accuracy": "ڕێژەی زانین",
    ...
    "badges.streak": "زنجیرەی سەرکەوتن", "badges.streakDesc": "دوو یان زیاتر) پێشبینی ڕاست بەدواداهاتوو)",
