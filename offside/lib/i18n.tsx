...
const dictionaries: Record<Lang, Record<string, string>> = {
  en: {
    "nav.predict": "Predict", "nav.leaderboard": "Leaderboard", "nav.stats": "My stats", "nav.news": "News", "nav.history": "History",
    "nav.board": "Board", "nav.signout": "Sign out",
    "competitions.pl": "Premier League",
    "competitions.cl": "Champions League",
    "competitions.pd": "La Liga",
    "competitions.sa": "Serie A",
    "competitions.fl1": "Ligue 1",
    ...
    "match.opens": "Opens for predictions", "match.finalResult": "Final result", "match.awaitingResult": "Awaiting result",
    ...
    "leaderboard.loginToSee": "Log in to see the full leaderboard",
    "leaderboard.anonymous": "Anonymous",
    "leaderboard.loginToSeeFull": "Log in to see who's who",
    ...
    "stats.pointsByLeague": "Points by League",
  ...
  ar: {
    ...
    "dashboard.previous": "السابقة",
    "dashboard.next": "التالية",
    "match.live": "مباشر", "match.final": "انتهت", "match.saved": "تم الحفظ",
    "match.opens": "متاح للتوقع", "match.finalResult": "النتيجة النهائية", "match.awaitingResult": "بانتظار النتيجة",
    ...
    "leaderboard.loginToSee": "سجّل الدخول لرؤية الترتيب الكامل",
    "leaderboard.anonymous": "مجهول",
    "leaderboard.loginToSeeFull": "سجّل الدخول لمعرفة من هو من",
    ...
    "stats.pointsByLeague": "النقاط حسب الدوري",
    "competitions.pl": "الدوري الإنجليزي",
    "competitions.cl": "دوري أبطال أوروبا",
    "competitions.pd": "الدوري الإسباني",
    "competitions.sa": "الدوري الإيطالي",
    "competitions.fl1": "الدوري الفرنسي",
    "competitions.bl1": "الدوري الألماني",
    ...
    "activity.predicted": "توقع", "activity.boosted": "مُعزّز", "history.title": "أرشيف المواسم", "history.subtitle": "نقاطك من البطولات المنتهية", "history.empty": "لا توجد مواسم منتهية بعد.", "history.points": "نقطة",
  },
  ckb: {
    "nav.predict": "پێشبینی", "nav.leaderboard": "پلەبەندی", "nav.stats": "ئامارەکانم", "nav.news": "هەواڵ", "nav.history": "مێژوو",
    ...
    "auth.emailWarning": "بێ ئیمەیل ناتوانرێت هەژمار بگەڕێندرێتەوە! ئەگەر وشەی نهێنیت لەبیرکرد ناتوانیت هەژمارەکەت بگەڕێنیتەوە.",
    ...
    "dashboard.title": "یارییە داهاتووەکان", "dashboard.openCount": "پێشبینی کراوەیە",
    ...
    "match.opens": "بۆ پێشبینی کراوەیە", "match.finalResult": "ئەنجامی کۆتایی", "match.awaitingResult": "چاوەڕوانی ئەنجام",
    ...
    "match.baghdad": "بەغدا",
    "leaderboard.title": "פלەبەندي", "leaderboard.noPlayers": "ههشتا ياريزانك نيني.",
    "leaderboard.scored": "خالي دراو",
    "leaderboard.loginToSee": "به جوور بۆ بینینی فەلبەندییەکی تەواو",
    "leaderboard.anonymous": "ناگەرێن",
    "leaderboard.loginToSeeFull": "به جوور بۆ بینینی کەس کەس",
    ...
    "stats.pointsByLeague": "خاڵەکان لەگەڵ لیگ",
    "competitions.pl": "لیگی بريتیانی",
    "competitions.cl": "لیگی شامپینی خوڕ",
    "competitions.pd": "لیگی Spani",
    "competitions.sa": "لیگی إيطالیا",
    "competitions.fl1": "لیگی فڕانسە",
    "competitions.bl1": "لیگی جەرمانیا",
    ...
    "activity.predicted": "پێشبینی کرد", "activity.boosted": "بووستکرا", "history.title": "مێژووی وەرزەکان", "history.subtitle": "خاڵەکانت لە پێشبڕکێی تەواوبوو", "history.empty": "هێشتا هیچ وەرزێک تەواو نەبووە.", "history.points": "خاڵ",
  },
};
